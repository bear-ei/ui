...
const ForwardRefTextFieldPicker = forwardRef<TextInput, TextFieldPickerProps>(
    (props, ref) => (
        <TextFieldPickerBase
            {...props}
            ref={ref}
...
export const TextFieldPicker: FC<TextFieldPickerProps> =
    ForwardRefTextFieldPicker
