...
} from './Layout-navigation.interface'
...
const ForwardRefLayoutNavigation = forwardRef<View, LayoutNavigationProps>(
    (props, ref) => (
...
export const LayoutNavigation =
    ForwardRefLayoutNavigation as FC<LayoutNavigationProps>
