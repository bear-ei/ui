		...
		return (
			<AnimatedView
				...
				className={classesName('flex flex-1 flex-row self-stretch overflow-hidden', {
					['justify-start']:
						type === SIDE_SHEET_TYPE.MODAL && position === SIDE_SHEET_POSITION.HORIZONTAL_START,
					['justify-end']: type === SIDE_SHEET_TYPE.MODAL && position === SIDE_SHEET_POSITION.HORIZONTAL_END,
			...
			>
				...
				>
					<View
						className={classesName('flex flex-row items-center gap-1 self-stretch pb-4 pr-1 pt-4', {
							['pl-4']: !!leadingElement,
							['pl-6']: !leadingElement,
						...
						>
							<Text
								className={classesName(
									...
									typographyClasses(TYPOGRAPHY.TITLE)(TYPOGRAPHY_SIZE.LARGE)({
					...
					>
						...
						>
							...
							<View
								className={'flex flex-row gap-2 bg-[--color-surface-container-low] pb-6 pl-6 pr-6 pt-4'}
