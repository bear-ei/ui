...
export const createAnimateTextInputEnabledState =
    ...
    ({activeIndicatorScaleYSharedValue, colorSharedValue, inputColorSharedValue}: CreateTextInputEnabledSharedValues) =>
    (error?: boolean) => {
        if (error) {
            return
        }
...
export const createAnimateTextInputErrorState =
    (animateSharedValueTo: AnimateSharedValueTo) =>
    ({activeIndicatorScaleYSharedValue, colorSharedValue, inputColorSharedValue}: CreateTextInputErrorSharedValues) => {
