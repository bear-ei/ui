...
describe('Divider', () => {
	it('should render horizontal divider with default props', () => {
		...
		const container = getByTestId('divider--test-id')
		const content = getByTestId('divider__content--test-id')
	...
	it('should apply small size when subheader exists and layout is horizontal', () => {
		...
		const subheader = getByTestId('divider__subheader--test-id')
	...
	it('should not render subheader when not provided', () => {
		...
		const subheader = queryByTestId('divider__subheader--test-id')
