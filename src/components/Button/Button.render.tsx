					...
					>
						<View
							className={classesName(
								...
								{
									['pl-2 pr-2']: type !== BUTTON_TYPE.LINK && size === SIZE.EXTRA_SMALL,
									['pl-3 pr-3']: type !== BUTTON_TYPE.LINK && size === SIZE.SMALL,
									['pl-4 pr-4']: type !== BUTTON_TYPE.LINK && size === SIZE.MEDIUM,
									['pl-5 pr-5']: type !== BUTTON_TYPE.LINK && size === SIZE.LARGE,
									['pl-6 pr-6']: type !== BUTTON_TYPE.LINK && size === SIZE.EXTRA_LARGE
								}
							)}
