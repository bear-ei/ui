...
import {
    HandleSkeletonAnimatedTimingOptions,
    UseSkeletonAnimatedOptions
...
export const useSkeletonAnimated = ({
    enableAnimated,
    skeletonVisible
}: UseSkeletonAnimatedOptions) => {
    ...
    const onSkeletonAnimatedTiming = useMemo(
        () =>
            handleSkeletonAnimatedTiming({animatedTiming, enableAnimated})(
                opacitySharedValue
            ),
