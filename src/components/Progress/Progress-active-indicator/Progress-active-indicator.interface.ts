...
export interface ProgressActiveIndicatorProps
    extends ViewProps,
        RefAttributes<View> {
...
export interface RenderProgressActiveIndicatorProps
    extends Omit<ProgressActiveIndicatorProps, 'containerLayout'> {
    containerAnimatedStyle: AnimatedStyle<ViewStyle>
}

export interface ProgressActiveIndicatorBaseProps
    extends ProgressActiveIndicatorProps {
