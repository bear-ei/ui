...
import {HandleProgressStateChangedOptions, ProgressBaseProps, ProgressState} from './Progress.interface'
...
const handleTouchableStateChanged =
        ({eventName, onLayoutChanged}: HandleProgressStateChangedOptions) =>
        (event: StateEvent) => {
                const nextEvent = {
